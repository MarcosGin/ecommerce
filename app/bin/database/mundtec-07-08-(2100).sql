...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-08-2017 a las 01:58:15
...
CREATE TABLE `myhistory` (
  `id` int(11) NOT NULL,
  `cart_id` varchar(100) COLLATE utf8_bin NOT NULL,
...
--
-- Volcado de datos para la tabla `myhistory`
--

INSERT INTO `myhistory` (`id`, `cart_id`, `produc_id`, `quantity`, `price`) VALUES
(1, '596d7e255bacb', 1, 1, 7000),
(2, '596d7f2851521', 1, 1, 7000),
(3, '596d7f38a5369', 1, 1, 7000),
(4, '596d7f9b8db8e', 1, 6, 7000),
(5, '596d82ca972d8', 2, 7, 6000),
(6, '5987cf6883ba1', 4, 1, 7000),
(7, '5987cf6883baa', 1, 1, 7000),
(8, '5987cf6883baa', 3, 1, 9700);
...
--
-- Volcado de datos para la tabla `product_comment`
--

INSERT INTO `product_comment` (`id`, `product_id`, `user_id`, `username`, `coment`, `fecha`) VALUES
(1, 1, 2, 'Marcos Gin', 'Hi!', '1499868787'),
(2, 2, 2, 'Marcos Gin', 'Hi!', '1499894961');
...
CREATE TABLE `users` (
  ...
  `dayBirth` int(11) NOT NULL,
  `monthBirth` int(11) NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `lastname`, `password`, `email`, `gender`, `dni`, `phone`, `rank`, `cash`, `dayBirth`, `monthBirth`, `yearBirth`, `country`, `img`, `newlatter`) VALUES
(1, 'Marcos', 'Gin', '$2y$10$3CG3Vvtubduf2ZFkYafyqO1D1VH4wkTglIM4v/tcyNFckZ.HVF.nO', 'marcosgin291@gmail.com', 'male', 42270070, '1231241232', 0, 0, 30, 5, 1999, 'ar', 'none.jpg', 0);
...
CREATE TABLE `users_activate` (
  ...
  `change_email` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `users_carts`
--
...
--
-- Volcado de datos para la tabla `users_carts`
--

INSERT INTO `users_carts` (`id`, `cart_id`, `user_id`, `created_at`) VALUES
(1, '5987cf6883baa', 1, 1500347941),
(2, '5987cf6883ba1', 1, 1502072680);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `users_change_email`
--

CREATE TABLE `users_change_email` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
INSERT INTO `users_sessions` (`id`, `user_id`, `jwt`, `activate`) VALUES
(1, 1, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..OfzYy9cvFaW8gdT4Hd1Vnuyk1nVg8fGt_ftqM7-2g3A', 1);
...
--
-- Indices de la tabla `users_carts`
--
ALTER TABLE `users_carts`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `users_change_email`
--
ALTER TABLE `users_change_email`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `users_activate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `users_carts`
--
ALTER TABLE `users_carts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `users_change_email`
--
ALTER TABLE `users_change_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
