...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-08-2017 a las 21:29:55
...
CREATE TABLE `myhistory` (
  `id` int(11) NOT NULL,
  `buy_id` varchar(100) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `myhistory` (`id`, `buy_id`, `user_id`, `produc_id`, `quantity`, `price`, `fecha`) VALUES
(1, '596d7e255bacb', 2, 1, 1, 7000, 1500347941),
(2, '596d7f2851521', 2, 1, 1, 7000, 1500348200),
(3, '596d7f38a5369', 2, 1, 1, 7000, 1500348216),
(4, '596d7f9b8db8e', 2, 1, 6, 7000, 1500348315),
(5, '596d82ca972d8', 2, 2, 7, 6000, 1500349130),
(6, '5975a6a78cf9c', 2, 4, 1, 7000, 1500882599);
...
(2, 'Marco', 'Gin', '$2y$10$qTQZrub9olPCBYjopmqRheurWTGyO8nXoI2js5c7kpuBkm0qqKC4i', 'marcosgin291@gmail.com', 'male', 42270079, '1533445690', 0, 0, 30, 5, 1992, 'ar', 'none.jpg', 0);
