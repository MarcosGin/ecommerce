...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2017 a las 02:04:03
...
--
-- Estructura de tabla para la tabla `productcoment`
--
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `nombre` varchar(155) COLLATE utf8_bin NOT NULL,
  `apellido` varchar(155) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `users` (`id`, `nombre`, `apellido`, `password`, `email`, `genero`, `documento`, `tipoDocumento`, `phone`, `rank`, `cash`, `dateuser`, `img`, `newlatter`) VALUES
(1, 'Marcos', 'Gin', '192908ffc30df3613cca3bf8f1119aa4', 'marcosgin291@gmail.com', 'Masculino', 42270070, 'DNI', '', 1, 30000, '30/5/1999', '', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usersconf`
--

CREATE TABLE `usersconf` (
  `id` int(11) NOT NULL,
  `UserId` int(11) NOT NULL,
  `codigo` varchar(155) COLLATE utf8_bin NOT NULL,
  `token` varchar(255) COLLATE utf8_bin NOT NULL,
  `activi` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Indices de la tabla `productcoment`
--
ALTER TABLE `productcoment`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `usersconf`
--
ALTER TABLE `usersconf`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `productcoment`
--
ALTER TABLE `productcoment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `usersconf`
--
ALTER TABLE `usersconf`
